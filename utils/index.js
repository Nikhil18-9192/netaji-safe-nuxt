...
const libraryCabinate = {
    cards: [
        { title: '', desc: 'Netaji Special 6 door cabinet with glass doors with 2 shelves making three compartment above & below. Glass is fitted in aluminum section with rubber.', size: ' H-78″ x W-47″ x D-15″', note: 'Also available in customised sizes.', icon: '/dumbbell.svg' },
        { title: '', desc: 'Netaji Book Case for storage of articles and books, for easy identification, 4 compartments with glass panels, each with disappearing glass shutter fitted with 2 handles in each door and 4 locks with the common S.S. Keys in duplicate.', size: 'H-66″ x W-33″ x D-12″', note: 'also available in two compartments with top and in different sizes.', icon: '/pattern.svg' },
...
const pigeonHole = {
    cards: [
        { title: '', desc: 'Netaji offers a wide range of Pigeon Hole Cabinets for various use in offices These cabients come in different sizes and number of sub cabinets vary from 4, 6, 8, 12, 18 & 21. The models with 4 and 6 doors further have 1 shelf making 2 compartments each, thus giving maximum usage space.The Standard Size of the Pigeon Hole Cabinet is H-78″ x W-38″ x D-18″', icon: '/pegeon-hole.svg' },
