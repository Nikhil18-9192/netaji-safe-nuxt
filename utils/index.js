...
const homeRange = [
    ...
    { title: 'Domestic Cabinet - Full Dressing', desc: 'Domestic Cabinet with half safe, 2 drawers, 1 above hanging rod, 2 shelves making three compartments and one hidden shelf at bottom.', model: 'NSCH 205', size: 'H-78″ X W-38″ x D-21', model1: 'NSCH 205 A', size1: ' H-78″ X W-34″ x D-21', p: 'Other Sizes as per client specification provided.', src: require('~/assets/products/home range/h3.jpg') },
    { title: 'Twin Cabinet ( Sangam )', desc: 'Sangam Twin Cabinet for individual use of 2 members of same house or hostel. The cabinet is with two separate locking arrangement each part having partition, 1 drawer, 1 hanging rod, 1 safe & 2 shelves is each part. Mirror fitted in each door.', model: 'NSCH 207', size: 'H-78″ X W-47″ x D-21"', p: 'Sizes can vary according to client needs.', src: require('~/assets/products/home range/h4.jpg') },
    { title: 'Domestic Cabinet – Khana Bhandar', desc: 'Domestic Cabinet (Khana Bhandar) with vertical partition, rod for hanging on both sides, 1 half safe, 1 Shelf making two compartments and 8-10 hidden compartments (chor khane) below with magnetic lock for 4 hidden compartments.', model: 'NSCH 203', size: 'H-78″ X W-38″ x D-24″', p: 'Customisations as per individual requirement provided.', src: require('~/assets/products/home range/h5.jpg') },
    { title: 'Domestic Cabinet – Tijori Dressing', desc: 'Domestic Storage Cabinet (Tijori Dressing), with 1 shelves with with two hanging rods on both sides, 1 drawer, 1 full safe having 1 drawer and hidden compartment inside.', model: 'NSCH 206', size: 'H-78″ X W-38″ x D-21″ / 24″', p: 'We also provide different sizes as ordered.', src: require('~/assets/products/home range/h6.jpg') },
    { title: 'Domestic Cabinet – Centre Drawer Dressing', desc: 'Domestic Cabinet with 1 shelf, vertical partition, 2 hanging rods, 1 drawer & 1 more shelf below making two compartments.', model: 'NSCH 204', size: 'H-78″ X W-38″ x D-21″ / 24″', p: 'Others Sizes available on request.', src: require('~/assets/products/home range/h7.jpg') },
    { title: 'Domestic Cabinet - Goa Type', desc: 'Domestic Cabinet with vertical partition 2 hanging rods, 1 drawer and 1 half safe. Two partitions making 3 compartments.', model: ' NSCH 202', size: 'H-78″ X W-34/38″ x D-21″ / 24″ ', p: 'Others Sizes available on request.', src: require('~/assets/products/home range/h8.jpg') },
    { title: 'Domestic Cabinet - 2 Drawers Half Safe', desc: 'Domestic Cabinet with half safe & half vertical partition, 2 drawers, 1 hanging rod & 2 shelves making three compartments.', model: 'NSCH 201', size: 'H-78″ X W-36″ x D-21', p: 'Customisations as per individual requirement provided.', src: require('~/assets/products/home range/h2.jpg') },
]

const officeRange = [
    { title: 'Storewell Cabinet', desc: 'Multi Purpose Storage Cabinet with four shelves making five compartments. ', model: 'NSCO 201', size: 'H-78″ x W-36″ x D-19″', p: 'Can also be made in fire proof material.', src: require('~/assets/products/office range/o1.jpg') },
    { title: 'Netaji Junior-Locker Storewell Cabinet', desc: 'Netaji Mini Domestic Cabinet with 1 shelf and 1 full safe.', model: 'NSCO 208', size: 'H-48″ x W-30″ x D-18″', p: 'The dimensions can be customised as required, while ordering.', src: require('~/assets/products/office range/o2.jpg') },
    { title: 'Netaji Center Tijori Storewell Cabinet', desc: 'NETAJI Storage Cabinet with two shelves and one full safe in center, along with one hidden compartment.', model: 'NSCTS 202', size: 'H-78″ x W-34″ x D-19″ | H-78″ x W-36″ x D-19″', p: 'Also available in other sizes as per requirement.', src: require('~/assets/products/office range/o3.jpg') },
    ...
    {
        title: 'Netaji Double Table', desc: 'With M.S.Steel of 1.6mm thickness fitted with three box drawers on right, with automatic locking and one locker shelf on left. ',
        model: 'NSCO 301', size: 'H-30″ x W-54″ x D-30″',
    ...
    { title: 'Netaji Cash Box', desc: 'Netaji Steel Cash Box available in table fit and without table fit arrangement.  ', size: '10 ” , 12″ , 14″ , 16″ (in width)', p: 'as well as customised Size', src: require('~/assets/products/office range/o8.jpg') },
...
const coffer = {
    cards: [
        ...
        { title: 'Coffer with Digital & Key Lock', desc: 'The Most prominent features of this products are : ~ Hot Moving Product in present times. Compact in size but still offering high security. Coffer with Drawer is Used in Offices, Homes, Institutions and almost every place which involves cash and other valuable items. Fitted on a table or any convenient location even a wardrobe. Available in both Horizontal as well as Vertical shape.Coffer with Digital Lock. ', desc2: ' Any Customised size as per requirement.Coffer with Digital / Combination Lock. Secure Locking System available in both (LG Locks) as well as Key Locking System. Coffers can be fitted any where and be shaped as per the interiors of the location it is to be placed in. Coffers are available in many vibrant dual tone colors and can also be colored as per requirements.', dimentions: ['10" x 15" x 12"', '15" x 18" x 14"', '16″ x 20″ x 16″', '24″ x 18″ x 18″', '30″ x 24″ x 18″', '36″ x 30″ x 21″'], icon: '/coffer-digital.svg' },
